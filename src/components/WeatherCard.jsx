...
const WeatherCard = () => {
  ...
  return (
    <div className='col-md-4 col-sm-12 h-100vh position-sicky top-40% '>
        <div className="card p-5 rounded-0 bg-dark bg-gradient shadow-sm " style={{backgroundImage:`url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRm2h7tHE1iZGRinrLlgYjDlSOSOBRKz-9S9g&usqp=CAU)`}}>
